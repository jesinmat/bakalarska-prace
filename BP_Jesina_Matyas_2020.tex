...
servers in cloud environments. It explores existing possibilities of deploying applications in cloud to find the optimal solution
...
\appendix
\input{chapters/appendix/acronyms.tex}
